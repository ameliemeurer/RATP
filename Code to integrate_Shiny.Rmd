...
df_distances <- as.data.frame(distances(temps_trajet_igraph, V(temps_trajet_igraph)[stop_name == "Pont de Neuilly"], to = V(temps_trajet_igraph)[stop_name =="Porte Maillot"]))
