...
```{r}
trajet_plus_court <- shortest_paths(temps_trajet_igraph, V(temps_trajet_igraph)[stop_name =="Boulogne-Jean-Jaurès"], to = V(temps_trajet_igraph)[stop_name =="Javel-André-Citroen"], output = "vpath")
...
```{r}
df_distances <- as.data.frame(distances(temps_trajet_igraph, V(temps_trajet_igraph)[stop_name =="Boulogne-Jean-Jaurès"], to = V(temps_trajet_igraph)[stop_name =="Javel-André-Citroen"]))

```


```{r}
as_data_frame(distances(temps_trajet_igraph, V(temps_trajet_igraph)[stop_name =="Boulogne-Jean-Jaurès"], to = V(temps_trajet_igraph)[stop_name =="Javel-André-Citroen"]))
```
